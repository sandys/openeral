...
///
/// Creates the `_openrind` schema and internal metadata tables.
...
/// Record a mount session in the `_openrind.mount_log` table.
pub async fn log_mount_session(
    ...
    client
        .execute(
            "INSERT INTO _openrind.mount_log (mount_point, schemas_filter, page_size, openrind_shell_version) \
             VALUES ($1, $2, $3, $4)",
