...
Shared UI primitives for Openrind Desktop apps.

This package intentionally ships two framework-specific entrypoints:

- `@openrind/ui/react` for React apps like `ee/apps/den-web`
- `@openrind/ui/solid` for Solid apps like `apps/app`
...
The first shared components live under the `paper` namespace and wrap Paper Design shaders with Openrind Desktop-specific defaults and deterministic seed support.
