...
Skill hubs are the team-wide way to distribute grouped skills in OpenrindDesktop Cloud. You create the skills and team assignments in the Cloud dashboard, then each desktop workspace can import the hub in one step.
...
If you do not already have one, open [app.openrind-desktoplabs.com](https://app.openrind-desktoplabs.com/), click `Create organization`, enter the org name, and finish checkout if prompted.
...
<Frame>
  ![Skill hub access and included skills in OpenrindDesktop Cloud](/images/cloud-skill-hub-access-and-skills.png)
</Frame>
...
4. Reload the workspace when OpenrindDesktop asks.

OpenrindDesktop installs the hub's skills into `.opencode/skills` for that workspace.
