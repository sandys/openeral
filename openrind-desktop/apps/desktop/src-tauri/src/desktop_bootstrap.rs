...
const DESKTOP_BOOTSTRAP_PATH_ENV: &str = "OPENRIND_DESKTOP_DESKTOP_BOOTSTRAP_PATH";
const DEFAULT_DEN_BASE_URL: &str = "https://app.openrind-desktoplabs.com";
...
fn seed_desktop_bootstrap_config() -> Result<DesktopBootstrapConfig, String> {
    normalize_desktop_bootstrap_config(&DesktopBootstrapConfig {
        base_url: trim_to_option(
            option_env!("OPENRIND_DESKTOP_DESKTOP_DEN_BASE_URL").or(option_env!("VITE_DEN_BASE_URL")),
        )
        .unwrap_or_else(|| DEFAULT_DEN_BASE_URL.to_string()),
        api_base_url: trim_to_option(
            option_env!("OPENRIND_DESKTOP_DESKTOP_DEN_API_BASE_URL")
                .or(option_env!("VITE_DEN_API_BASE_URL")),
        ),
        require_signin: env_truthy(
            option_env!("OPENRIND_DESKTOP_DESKTOP_DEN_REQUIRE_SIGNIN")
