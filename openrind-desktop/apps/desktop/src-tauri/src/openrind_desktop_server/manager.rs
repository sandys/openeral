...
#[derive(Default)]
pub struct OpenrindDesktopServerManager {
    pub inner: Arc<Mutex<OpenrindDesktopServerState>>,
}

#[derive(Default)]
pub struct OpenrindDesktopServerState {
...
impl OpenrindDesktopServerManager {
    pub fn snapshot_locked(state: &mut OpenrindDesktopServerState) -> OpenrindDesktopServerInfo {
    ...
    pub fn stop_locked(state: &mut OpenrindDesktopServerState) {
