...
const runtimeOutputSnapshotSchema = z.object({
  ...
  truncated: z.boolean(),
}).meta({ ref: "OpenrindDesktopServerV2RuntimeOutputSnapshot" });
...
const runtimeTargetSchema = z.enum([
  ...
  "windows-arm64",
  "windows-x64",
]).meta({ ref: "OpenrindDesktopServerV2RuntimeTarget" });
...
}).meta({ ref: "OpenrindDesktopServerV2RuntimeManifest" });
...
}).meta({ ref: "OpenrindDesktopServerV2RuntimeLastExit" });
...
const routerEnablementSchema = z.object({
  ...
  forced: z.boolean(),
  reason: z.string(),
}).meta({ ref: "OpenrindDesktopServerV2RouterEnablement" });
...
const routerMaterializationSchema = z.object({
  ...
  logFile: z.string(),
}).meta({ ref: "OpenrindDesktopServerV2RouterMaterialization" });
...
}).meta({ ref: "OpenrindDesktopServerV2RuntimeUpgradeState" });
...
}).meta({ ref: "OpenrindDesktopServerV2OpencodeHealthData" });
...
export const routerHealthDataSchema = z.object({
  ...
  status: runtimeChildStatusSchema,
  version: z.string().nullable(),
}).meta({ ref: "OpenrindDesktopServerV2RouterHealthData" });
...
export const runtimeVersionsDataSchema = z.object({
  ...
  target: runtimeTargetSchema,
}).meta({ ref: "OpenrindDesktopServerV2RuntimeVersionsData" });

export const opencodeHealthResponseSchema = successResponseSchema("OpenrindDesktopServerV2OpencodeHealthResponse", opencodeHealthDataSchema);
export const routerHealthResponseSchema = successResponseSchema("OpenrindDesktopServerV2RouterHealthResponse", routerHealthDataSchema);
export const runtimeSummaryResponseSchema = successResponseSchema("OpenrindDesktopServerV2RuntimeSummaryResponse", runtimeSummaryDataSchema);
export const runtimeVersionsResponseSchema = successResponseSchema("OpenrindDesktopServerV2RuntimeVersionsResponse", runtimeVersionsDataSchema);
export const runtimeUpgradeResponseSchema = successResponseSchema("OpenrindDesktopServerV2RuntimeUpgradeResponse", runtimeUpgradeDataSchema);
