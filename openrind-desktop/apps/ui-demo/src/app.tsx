    ...
    <main className="app-shell">
      ...
      <section className="hero-card panel">
        <div className="hero-copy">
          <span className="eyebrow">Openrind Desktop UI demo</span>
          ...
          <p>
            ...
            the gradients that `@openrind/ui/react` will render anywhere else in the repo.
          </p>
        </div>
      ...
      <section className="footer-grid">
        ...
        <div className="panel code-panel">
          ...
          <div className="pill-stack">
            <code className="import-pill">@openrind/ui/react</code>
            <code className="import-pill">@openrind/ui/solid</code>
          </div>
          <pre>{`import { PaperMeshGradient, PaperGrainGradient } from "@openrind/ui/react"
    ...
    <article className="panel preview-card">
      <div className="gradient-surface">
        ...
        <div className="surface-copy">
          <span className="eyebrow on-dark">@openrind/ui/react</span>
          <h2>{title}</h2>
          <p>{subtitle}</p>
        </div>
      </div>
