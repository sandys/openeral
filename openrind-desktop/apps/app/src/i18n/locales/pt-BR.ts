 ...
 * Termos profissionais (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Openrind Desktop) NÃO são traduzidos
 */
...
export default {
  ...
  "app.deep_link_auth_queued": "Link de autenticação Cloud enfileirado para o Openrind Desktop.",
  "app.deep_link_remote_queued": "Link de worker remoto enfileirado. O Openrind Desktop deve entrar no fluxo de conexão.",
  ...
  "app.error.tauri_required": "Esta ação requer o runtime do app desktop do Openrind Desktop.",
  "app.error_audit_load": "Falha ao carregar o log de auditoria.",
  "app.error_auth_failed": "Falha na autenticação",
  "app.error_auto_compact_scope": "A compactação automática de contexto só pode ser alterada para um workspace local ou um workspace de servidor Openrind Desktop com permissão de escrita.",
  "app.error_cloud_signin": "Falha ao concluir o login no Openrind Desktop Cloud.",
  ...
  "app.error_deep_link_unrecognized": "Esse link não é um deep link ou URL de compartilhamento reconhecido do Openrind Desktop.",
  "app.error_desktop_signin": "Login no desktop concluído, mas o Openrind Desktop Cloud não retornou um token de sessão.",
  ...
  "app.plugins_hint_disconnected": "Servidor Openrind Desktop indisponível. Plugins estão em modo somente leitura.",
  "app.plugins_hint_limited": "O servidor Openrind Desktop precisa de um token para editar plugins.",
  "app.plugins_hint_readonly": "O servidor Openrind Desktop está em modo somente leitura para plugins.",
  ...
  "app.reset_config_ok": "Configurações padrão do app redefinidas. Reinicie o Openrind Desktop se alguma configuração obsoleta permanecer.",
  "app.shared_setup": "Configuração compartilhada",
  "app.skill_added": "Skill adicionada",
  "app.skills_hint_disconnected": "Servidor Openrind Desktop indisponível. Adicione a URL/token do servidor em Avançado para gerenciar skills.",
  "app.skills_hint_limited": "O servidor Openrind Desktop precisa de um token de host para instalar/atualizar skills. Adicione-o em Avançado e reconecte.",
  "app.skills_hint_readonly": "O servidor Openrind Desktop está em modo somente leitura para skills. Adicione um token de host em Avançado para habilitar instalações.",
  ...
  "blueprint.welcome_message": "Olá, boas-vindas ao Openrind Desktop!\n\nAs pessoas usam o Openrind Desktop para escrever arquivos .csv no computador, conectar ao Chrome e automatizar tarefas repetitivas, e sincronizar contatos com o Notion.\n\nMas o único limite é a sua imaginação.\n\nO que você gostaria de fazer?",
  "blueprint.welcome_title": "Boas-vindas ao Openrind Desktop",
  ...
  "config.reload_availability_hint": "O recarregamento está disponível apenas para workers locais ou servidores Openrind Desktop conectados.",
  ...
  "config.server_needed_hint": "Conexão com o servidor Openrind Desktop necessária para sincronizar skills, plugins e comandos.",
  "config.server_section_desc": "Conecte a um servidor Openrind Desktop. Use a URL mais um token de colaborador ou proprietário do administrador do servidor.",
  ...
  "config.server_sharing_title": "Compartilhamento do servidor Openrind Desktop",
  "config.server_url_hint": "Use a URL compartilhada pelo seu servidor Openrind Desktop. Workers locais do desktop reutilizam uma porta alta persistente na faixa 48000-51000.",
  "config.server_url_input_label": "URL do servidor Openrind Desktop",
  "config.server_url_label": "URL do Servidor Openrind Desktop",
  ...
  "context_panel.authorized_folders_no_access": "Conecte a um workspace Openrind Desktop com permissão de escrita para editar as pastas autorizadas.",
  "context_panel.browse_button": "Navegar",
  "context_panel.config_access_unavailable": "O acesso à configuração do servidor Openrind Desktop não está disponível para este workspace.",
  "context_panel.config_read_only": "O servidor Openrind Desktop está conectado em modo somente leitura para configuração do workspace.",
  ...
  "context_panel.server_disconnected": "Servidor Openrind Desktop desconectado.",
  ...
  "context_panel.writable_workspace_required": "É necessário um workspace Openrind Desktop com permissão de escrita para atualizar as pastas autorizadas.",
  ...
  "dashboard.chooser_remote_desc": "Conecte a um worker Openrind Desktop auto-hospedado usando uma URL e token de acesso.",
  ...
  "dashboard.cloud_signin_title": "Entrar no Openrind Desktop Cloud",
  ...
  "dashboard.create_remote_custom_subtitle": "Conecte a um worker Openrind Desktop auto-hospedado.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Salvar um servidor Openrind Desktop como workspace.",
  ...
  "dashboard.create_shared_subtitle_signed_out": "Entre no Openrind Desktop Cloud para acessar workers compartilhados com sua organização.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Atualizar os dados do servidor Openrind Desktop para este workspace.",
  ...
  "dashboard.openrind_desktop_host_hint": "Use a URL fornecida pelo seu servidor Openrind Desktop.",
  "dashboard.openrind_desktop_host_label": "URL do servidor Openrind Desktop",
  "dashboard.openrind_desktop_host_placeholder": "https://seu-servidor.openrind-desktop.app",
  "dashboard.openrind_desktop_host_token_hint": "Opcional. Cole um token de colaborador para acesso rotineiro ou um token de proprietário quando este cliente precisar responder a prompts de permissão.",
  "dashboard.openrind_desktop_host_token_label": "Token de colaborador ou proprietário",
  "dashboard.openrind_desktop_host_token_placeholder": "Cole seu token",
  ...
  "dashboard.remote_server_details_hint": "Conecte a um worker Openrind Desktop auto-hospedado.",
  "dashboard.remote_server_details_title": "Detalhes do servidor remoto",
  "dashboard.remote_workspace_hint": "Acompanhe um servidor Openrind Desktop e reconecte a qualquer momento.",
  ...
  "dashboard.worker_url_hint": "Cole a URL do worker Openrind Desktop ao qual deseja conectar.",
  ...
  "den.auto_reconnect_hint": "Conclua a autenticação no navegador e o Openrind Desktop reconectará aqui automaticamente.",
  ...
  "den.cloud_sleep_hint": "Entre no Openrind Desktop Cloud para manter suas tarefas ativas mesmo quando seu computador entrar em suspensão.",
  "den.cloud_workers_hint": "Abra workers diretamente no Openrind Desktop usando o mesmo fluxo de conexão remota que o app já usa.",
  ...
  "den.error_no_token": "Login no desktop concluído, mas o Openrind Desktop Cloud não retornou um token de sessão.",
  "den.error_open_worker": "Falha ao abrir {name} no Openrind Desktop.",
  "den.error_open_worker_fallback": "Falha ao abrir {name}.",
  "den.error_paste_valid_code": "Cole um link de login do Openrind Desktop válido ou um código de uso único.",
  "den.error_signin_failed": "Falha ao concluir o login no Openrind Desktop Cloud.",
  ...
  "den.signin_code_note": "Aceita um link openrind-desktop://den-auth ou o código de uso único.",
  "den.signin_link_hint": "Se o navegador não redirecionar de volta para o Openrind Desktop automaticamente, cole o link de login ou código de uso único do Openrind Desktop Cloud aqui.",
  "den.signin_link_label": "Link de login ou código de uso único",
  "den.signin_link_placeholder": "openrind-desktop://den-auth?... ou código colado",
  "den.signin_title": "Entrar no Openrind Desktop Cloud",
  "den.signing_in": "Concluindo login no Openrind Desktop Cloud...",
  ...
  "den.status_browser_signin": "Conclua o login no navegador para conectar o Openrind Desktop.",
  "den.status_browser_signup": "Conclua a criação da conta no navegador para conectar o Openrind Desktop.",
  "den.status_cloud_signed_in_as": "Openrind Desktop Cloud conectado como {email}.",
  ...
  "den.status_opened_worker": "{name} aberto no Openrind Desktop.",
  "den.status_signed_in_as": "Conectado como {email}.",
  "den.status_signed_out": "Saiu do Openrind Desktop Cloud e a sessão foi limpa neste dispositivo.",
  ...
  "identities.connect_server_desc": "As identidades ficam disponíveis quando você está conectado a um servidor Openrind Desktop.",
  "identities.connect_server_title": "Conectar a um servidor Openrind Desktop",
  ...
  "identities.reconnect_failed": "Falha ao reconectar. Verifique a URL/token do Openrind Desktop e tente novamente.",
  ...
  "mcp.apps_subtitle": "Conecte suas ferramentas favoritas para que o Openrind Desktop as use em seu nome.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "Para isso ter efeito, o Openrind Desktop precisa reiniciar o serviço worker. Isso pode interromper uma sessão em andamento.",
  "mcp.auth.reload_remote_confirm": "Para isso ter efeito, o Openrind Desktop precisa reiniciar o serviço worker. Isso pode parar sua sessão em andamento. Continuar?",
  ...
  "mcp.auth.step2_title": "Autorizar o Openrind Desktop",
  ...
  "mcp.control_chrome_profile_hint": "O Control Chrome normalmente abre um perfil separado do Chrome. Ative isso se quiser que o Openrind Desktop reutilize a janela do Chrome que você já tem aberta.",
  "mcp.control_chrome_profile_title": "2. Escolher qual Chrome usar",
  "mcp.control_chrome_save": "Salvar configurações",
  "mcp.control_chrome_setup_subtitle": "Ative o acesso ao Chrome e escolha se o Openrind Desktop deve usar seu próprio perfil limpo ou se conectar ao Chrome que você já usa.",
  "mcp.control_chrome_setup_title": "Configurar Control Chrome",
  "mcp.control_chrome_toggle_hint": "Quando ativado, o Openrind Desktop adiciona --autoConnect para que o MCP se conecte a uma instância do Chrome que você já iniciou.",
  "mcp.control_chrome_toggle_label": "Usar meu perfil existente do Chrome",
  "mcp.control_chrome_toggle_off": "O Openrind Desktop abrirá um perfil separado do Chrome apenas para automação.",
  "mcp.control_chrome_toggle_on": "O Openrind Desktop reutilizará suas abas, cookies e logins atuais.",
  ...
  "mcp.login_unavailable": "Este app não suporta login pelo Openrind Desktop.",
  ...
  "onboarding.cli_install_commands": "Instale o OpenCode com um dos comandos abaixo e reinicie o Openrind Desktop.",
  ...
  "onboarding.remote_workspace_card_description": "Conecte a um servidor Openrind Desktop para acessar um workspace compartilhado.",
  "onboarding.remote_workspace_card_title": "Conectar um workspace remoto",
  "onboarding.remote_workspace_description": "Conecte a um servidor Openrind Desktop para acessar um workspace de qualquer lugar.",
  "onboarding.remote_workspace_title": "Conectar ao servidor Openrind Desktop",
  "onboarding.remove": "Remover",
  "onboarding.resolved_path": "Caminho resolvido",
  "onboarding.run_local": "Executar localmente",
  "onboarding.run_local_description": "O Openrind Desktop executa o OpenCode localmente e mantém seu trabalho privado.",
  "onboarding.search_notes": "Notas de busca",
  "onboarding.searching_host": "Conectando ao servidor Openrind Desktop...",
  ...
  "onboarding.starting_host": "Iniciando servidor Openrind Desktop...",
  ...
  "onboarding.welcome_title": "Como você quer executar o Openrind Desktop hoje?",
  "onboarding.windows_install_instruction": "Instale o OpenCode para Windows e reinicie o Openrind Desktop. Certifique-se de que opencode.exe está no PATH.",
  ...
  "session.attachments_connect_server": "Conecte ao servidor Openrind Desktop para anexar arquivos.",
  "session.back": "Voltar",
  ...
  "session.connect_to_sync": "Conecte ao servidor Openrind Desktop para sincronizar arquivos remotos.",
  ...
  "session.pick_folder_desc": "Escolha uma pasta de projeto ou notas existente e o Openrind Desktop a usará como workspace.",
  ...
  "session.share_host_url_and_token_required": "URL do host Openrind Desktop e token são obrigatórios.",
  "session.share_local_host_not_ready": "O host local do Openrind Desktop ainda não está pronto.",
  "session.share_missing_host_url": "URL do host Openrind Desktop ausente.",
  "session.share_missing_token": "Token do Openrind Desktop ausente.",
  ...
  "session.share_openrind_desktop_workers_only": "Links de compartilhamento estão disponíveis para workers Openrind Desktop.",
  ...
  "session.share_resolve_local_workspace_failed": "Não foi possível resolver este workspace no host local do Openrind Desktop.",
  "session.share_resolve_remote_workspace_failed": "Não foi possível resolver este workspace no host do Openrind Desktop.",
  ...
  "session.share_sign_in_required": "Entre no Openrind Desktop Cloud em Configurações para compartilhar com sua equipe.",
  "session.share_skills_set_desc": "Conjunto completo de skills de um workspace Openrind Desktop.",
  ...
  "session.upload_connect_server": "Conecte ao servidor Openrind Desktop para enviar arquivos para a pasta compartilhada.",
  ...
  "session.workspace_setup_desc": "Comece com um workspace guiado do Openrind Desktop ou escolha uma pasta existente.",
  ...
  "settings.background_checks_desc": "O Openrind Desktop sempre verifica ao iniciar. Também verifica uma vez",
  ...
  "settings.capabilities_title": "Capacidades do servidor Openrind Desktop",
  ...
  "settings.custom_binary_hint": "Use para apontar o Openrind Desktop para um build local do OpenCode",
  ...
  "settings.deeplink_hint": "Aceita openrind-desktop://, openrind-desktop-dev:// ou uma URL https://share.openrind-desktoplabs.com/b/... raw suportada.",
  ...
  "settings.docker_containers_desc": "Forçar remoção de containers Docker iniciados pelo Openrind Desktop",
  "settings.docker_containers_title": "Containers Docker do Openrind Desktop",
  ...
  "settings.enable_exa_desc": "Aplica-se quando o Openrind Desktop Orchestrator inicia o OpenCode.",
  ...
  "settings.feedback_title": "Ajude a moldar o Openrind Desktop",
  ...
  "settings.nuke_confirm_dev": "Isso é irreversível. EXCLUIRÁ todos os dados do Openrind Desktop para este build dev e toda config, auth, cache, dados e estado isolados do OpenCode dev, e fechará o Openrind Desktop. Continuar?",
  "settings.nuke_confirm_prod": "Isso é irreversível. EXCLUIRÁ todos os dados do Openrind Desktop para este build dev e toda config, auth, cache, dados e estado isolados do OpenCode dev, e fechará o Openrind Desktop. Continuar?",
  "settings.nuke_failed": "Falha ao remover estado do Openrind Desktop e OpenCode.",
  "settings.nuke_hint": "Use apenas quando quiser resetar completamente o app desktop e o estado do runtime OpenCode.",
  "settings.nuke_success": "Estado do Openrind Desktop e OpenCode removido. O Openrind Desktop está fechando...",
  "settings.off": "Desativado",
  "settings.offline": "Offline",
  "settings.on": "Ativado",
  "settings.open_deeplink_action": "Abrindo...",
  "settings.open_deeplink_button": "Ocultar",
  "settings.open_deeplink_desc": "Cole um deeplink ou URL compartilhada do Openrind Desktop para abrir.",
  ...
  "settings.openrind_desktop_config_sidecar_desc": "Sidecar de configuração e aprovações.",
  "settings.openrind_desktop_diagnostics_title": "Diagnósticos do servidor Openrind Desktop",
  "settings.openrind_desktop_server_desc": "Plano de controle de sessão para sincronização do app, workers e acesso remoto.",
  ...
  "settings.quit_hint": "O Openrind Desktop fecha imediatamente após a limpeza para que a próxima inicialização comece de um estado local limpo para este modo.",
  ...
  "settings.reconnect_server_failed": "Falha ao reconectar o servidor Openrind Desktop.",
  "settings.reconnected": "Reconectado ao servidor Openrind Desktop.",
  ...
  "settings.reset_app_data_description": "Mais agressivo. Apaga cache + dados do Openrind Desktop.",
  "settings.reset_app_data_title": "Redefinir dados do app",
  "settings.reset_app_data_warning": "Apaga cache e dados do Openrind Desktop neste dispositivo.",
  ...
  "settings.reset_confirmation_hint": "Digite {resetWord} para confirmar. O Openrind Desktop será reiniciado.",
  ...
  "settings.reset_onboarding_description": "Apaga as preferências do Openrind Desktop e reinicia o app.",
  "settings.reset_onboarding_title": "Redefinir onboarding",
  "settings.reset_onboarding_warning": "Apaga preferências locais e marcadores de onboarding do workspace no Openrind Desktop.",
  "settings.reset_openrind_desktop_desc_dev": "Com o modo dev ativo, limpa apenas o estado isolado do OpenCode dev dentro de openrind-desktop-dev-data.",
  "settings.reset_openrind_desktop_desc_prod": "Com o modo dev ativo, limpa apenas o estado isolado do OpenCode dev dentro de openrind-desktop-dev-data.",
  "settings.reset_openrind_desktop_title": "Redefinir estado do Openrind Desktop + OpenCode",
  ...
  "settings.restart_blocked_message": "O Openrind Desktop precisa reiniciar para concluir esta atualização. Para não interromper seu trabalho atual, a instalação está pausada até que suas execuções ativas terminem ou sejam paradas.",
  ...
  "settings.runtime_desc": "Status do seu engine local e servidor Openrind Desktop.",
  ...
  "settings.tab_description_appearance": "Ajuste a aparência do Openrind Desktop no desktop, tema do sistema e decoração do app.",
  "settings.tab_description_debug": "Revise diagnósticos do runtime, logs e utilitários de depuração de baixo nível.",
  "settings.tab_description_den": "Gerencie sua conexão Openrind Desktop Cloud, workers hospedados e acesso a workspaces.",
  ...
  "settings.tab_description_general": "Conecte provedores, escolha o modelo padrão, autorize pastas e controle o workspace Openrind Desktop selecionado e sua conexão de runtime.",
  ...
  "settings.updates_desc": "Manter o Openrind Desktop atualizado.",
  ...
  "share.cloud_signin_note": "O Openrind Desktop Cloud abre no navegador e retorna aqui após o login.",
  ...
  "share.team_intro": "Salve este template na organização ativa do Openrind Desktop Cloud para que colegas possam abri-lo depois pelas configurações do Cloud.",
  ...
  "share.template_item_config_desc": "Comandos reutilizáveis mais configuração do Openrind Desktop/OpenCode.",
  ...
  "share_skill_destination.connect_remote_desc": "Vincular um host Openrind Desktop e selecioná-lo na lista para importar esta skill.",
  "share_skill_destination.connect_remote_hint": "Vincule um host Openrind Desktop e selecione-o na lista para importar esta skill.",
  ...
  "skills.add_openrind_desktop_hub": "Adicionar Openrind Desktop Hub",
  ...
  "skills.cloud_install_need_server": "Conecte a um servidor Openrind Desktop com acesso de escrita a skills para instalar skills de equipe neste worker.",
  ...
  "skills.cloud_section_subtitle": "Skills compartilhadas com você pelo Openrind Desktop Cloud — incluindo hubs de skills da equipe que você pode acessar.",
  ...
  "skills.cloud_sign_in_hint": "Entre no Openrind Desktop Cloud para navegar por skills de equipe e organização.",
  ...
  "skills.host_only_error": "O gerenciamento de skills requer um workspace local ou servidor Openrind Desktop conectado.",
  ...
  "skills.share_chooser_subtitle": "Salve na sua organização Openrind Desktop Cloud ou publique um link de instalação público.",
  ...
  "skills.share_option_team_desc": "Adicione esta skill à organização ativa do Openrind Desktop Cloud.",
  ...
  "skills.share_team_sign_in_hint": "O Openrind Desktop Cloud abre no navegador. Volte aqui após entrar.",
  ...
  "status.limited_hint": "Reconecte para restaurar todos os recursos do Openrind Desktop",
  ...
  "status.openrind_desktop_ready": "Openrind Desktop Pronto",
  ...
  "system.reload_body_default": "O Openrind Desktop detectou mudanças que exigem recarregar a instância do OpenCode.",
  "system.reload_body_mcp": "O OpenCode carrega servidores MCP na inicialização. Recarregue o engine para ativar a nova conexão.",
  "system.reload_body_mixed": "O Openrind Desktop detectou mudanças na configuração do OpenCode. Recarregue o engine para aplicá-las.",
