 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Openrind Desktop) are NOT translated
 */
...
export default {
  ...
  "app.deep_link_auth_queued": "Queued the Cloud auth deep link for Openrind Desktop.",
  "app.deep_link_remote_queued": "Queued remote worker link. Openrind Desktop should move into the connect flow.",
  ...
  "app.error.tauri_required": "This action requires the Openrind Desktop desktop app runtime.",
  "app.error_audit_load": "Failed to load audit log.",
  "app.error_auth_failed": "Authentication failed",
  "app.error_auto_compact_scope": "Auto context compaction can only be changed for a local workspace or a writable Openrind Desktop server workspace.",
  "app.error_cloud_signin": "Failed to complete Openrind Desktop Cloud sign-in.",
  ...
  "app.error_deep_link_unrecognized": "That link is not a recognized Openrind Desktop deep link or share URL.",
  "app.error_desktop_signin": "Desktop sign-in completed, but Openrind Desktop Cloud did not return a session token.",
  ...
  "app.plugins_hint_disconnected": "Openrind Desktop server unavailable. Plugins are read-only.",
  "app.plugins_hint_limited": "Openrind Desktop server needs a token to edit plugins.",
  "app.plugins_hint_readonly": "Openrind Desktop server is read-only for plugins.",
  ...
  "app.reset_config_ok": "Reset app config defaults. Restart Openrind Desktop if any stale settings remain.",
  "app.shared_setup": "Shared setup",
  "app.skill_added": "Skill added",
  "app.skills_hint_disconnected": "Openrind Desktop server unavailable. Add the server URL/token in Advanced to manage skills.",
  "app.skills_hint_limited": "Openrind Desktop server needs a host token to install/update skills. Add it in Advanced and reconnect.",
  "app.skills_hint_readonly": "Openrind Desktop server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Openrind Desktop servers.",
  ...
  "config.server_needed_hint": "Openrind Desktop server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an Openrind Desktop server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Openrind Desktop server",
  ...
  "config.server_sharing_title": "Openrind Desktop server sharing",
  "config.server_url_hint": "Use the URL shared by your Openrind Desktop server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Openrind Desktop server URL",
  "config.server_url_label": "Openrind Desktop Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable Openrind Desktop server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "Openrind Desktop server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "Openrind Desktop server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "Openrind Desktop server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable Openrind Desktop server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted Openrind Desktop worker using a URL and access token.",
  ...
  "dashboard.cloud_signin_title": "Sign in to Openrind Desktop Cloud",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted Openrind Desktop worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an Openrind Desktop server as a workspace.",
  ...
  "dashboard.create_shared_subtitle_signed_out": "Sign in to Openrind Desktop Cloud to access workers shared with your organization.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Openrind Desktop server details for this workspace.",
  ...
  "dashboard.openrind_desktop_host_hint": "Use the URL shared by your Openrind Desktop server.",
  "dashboard.openrind_desktop_host_label": "Openrind Desktop server URL",
  "dashboard.openrind_desktop_host_placeholder": "https://your-server.openrind-desktop.app",
  "dashboard.openrind_desktop_host_token_hint": "Optional. Paste a collaborator token for routine access or an owner token when this client must answer permission prompts.",
  "dashboard.openrind_desktop_host_token_label": "Collaborator or owner token",
  "dashboard.openrind_desktop_host_token_placeholder": "Paste your token",
  ...
  "dashboard.remote_connection_openrind-desktop": "Openrind Desktop",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted Openrind Desktop worker.",
  "dashboard.remote_server_details_title": "Remote server details",
  "dashboard.remote_workspace_hint": "Track an Openrind Desktop server and reconnect anytime.",
  ...
  "dashboard.worker_url_hint": "Paste the URL for the Openrind Desktop worker you want to connect to.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and Openrind Desktop will reconnect here automatically.",
  ...
  "den.cloud_section_title": "Openrind Desktop Cloud",
  "den.cloud_sleep_hint": "Sign in to Openrind Desktop Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_workers_hint": "Open workers directly into Openrind Desktop using the same remote-connect flow the app already uses elsewhere.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but Openrind Desktop Cloud did not return a session token.",
  "den.error_open_worker": "Failed to open {name} in Openrind Desktop.",
  "den.error_open_worker_fallback": "Failed to open {name}.",
  "den.error_paste_valid_code": "Paste a valid Openrind Desktop sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete Openrind Desktop Cloud sign-in.",
  ...
  "den.signin_code_note": "Accepts an openrind-desktop://den-auth link or the raw one-time grant.",
  "den.signin_link_hint": "If your browser doesn't bounce back into Openrind Desktop automatically, paste the sign-in link or one-time code from Openrind Desktop Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "openrind-desktop://den-auth?... or pasted code",
  "den.signin_title": "Sign in to Openrind Desktop Cloud",
  "den.signing_in": "Finishing Openrind Desktop Cloud sign-in...",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect Openrind Desktop.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Openrind Desktop.",
  "den.status_cloud_signed_in_as": "Connected Openrind Desktop Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected Openrind Desktop Cloud.",
  ...
  "den.status_opened_worker": "Opened {name} in Openrind Desktop.",
  "den.status_signed_in_as": "Signed in as {email}.",
  "den.status_signed_out": "Signed out and cleared your Openrind Desktop Cloud session on this device.",
  "den.sync": "Sync",
  ...
  "identities.connect_server_desc": "Identities are available when you are connected to an Openrind Desktop host.",
  "identities.connect_server_title": "Connect to an Openrind Desktop server",
  ...
  "identities.reconnect_failed": "Reconnect failed. Check Openrind Desktop URL/token and try again.",
  ...
  "mcp.toggle_requires_server": "Connect to an Openrind Desktop server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so Openrind Desktop can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, Openrind Desktop needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, Openrind Desktop needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize Openrind Desktop",
  ...
  "mcp.control_chrome_profile_hint": "Control Chrome normally opens a separate Chrome profile. Turn this on if you want Openrind Desktop to reuse the Chrome window you already have open.",
  "mcp.control_chrome_profile_title": "2. Choose which Chrome to use",
  "mcp.control_chrome_save": "Save settings",
  "mcp.control_chrome_setup_subtitle": "Turn on Chrome access, then choose whether Openrind Desktop should use its own clean profile or attach to the Chrome you already use.",
  "mcp.control_chrome_setup_title": "Set up Control Chrome",
  "mcp.control_chrome_toggle_hint": "When this is on, Openrind Desktop adds --autoConnect so the MCP attaches to a Chrome instance you already started.",
  "mcp.control_chrome_toggle_label": "Use my existing Chrome profile",
  "mcp.control_chrome_toggle_off": "Openrind Desktop will launch a separate Chrome profile just for automation.",
  "mcp.control_chrome_toggle_on": "Openrind Desktop will reuse your current tabs, cookies, and sign-ins.",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Openrind Desktop.",
  ...
  "onboarding.cli_install_commands": "Install OpenCode with one of the commands below, then restart Openrind Desktop.",
  ...
  "onboarding.remote_workspace_card_description": "Connect to an Openrind Desktop server to access a shared workspace.",
  "onboarding.remote_workspace_card_title": "Connect a remote workspace",
  "onboarding.remote_workspace_description": "Connect to an Openrind Desktop server to access a workspace from anywhere.",
  "onboarding.remote_workspace_title": "Connect to Openrind Desktop server",
  "onboarding.remove": "Remove",
  "onboarding.resolved_path": "Resolved path",
  "onboarding.run_local": "Run locally",
  "onboarding.run_local_description": "Openrind Desktop runs OpenCode locally and keeps your work private.",
  "onboarding.search_notes": "Search notes",
  "onboarding.searching_host": "Connecting to Openrind Desktop server...",
  "onboarding.serve_help": "serve --help output",
  "onboarding.show_search_notes": "Show search notes",
  "onboarding.start": "Start Openrind Desktop",
  "onboarding.starting_host": "Starting Openrind Desktop server...",
  ...
  "onboarding.welcome_title": "How would you like to run Openrind Desktop today?",
  "onboarding.windows_install_instruction": "Install OpenCode for Windows, then restart Openrind Desktop. Ensure opencode.exe is on PATH.",
  "onboarding.workspace_folder_label": "A workspace is a folder with its own skills, plugins, and commands.",
  "welcome.title": "Welcome to Openrind Desktop",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. Openrind Desktop will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and Openrind Desktop can pick them up.",
  "plugins.add": "Add",
  ...
  "sandbox.agent_claude": "Claude Code",
  "sandbox.agent_label": "Agent",
  "sandbox.agent_openclaw": "OpenClaw",
  "sandbox.auth_missing_desc": "The required Haloop edge needs an upstream Anthropic API key. Desktop keeps it outside the sandbox; set it before creating Claude or OpenClaw sandboxes.",
  "sandbox.auth_missing_title": "ANTHROPIC_API_KEY is not configured",
  "sandbox.cmd_search_detail": "{count} available",
  "sandbox.cmd_search_title": "Search sandboxes",
  "sandbox.create_launch": "Create & launch",
  "sandbox.creates_name": "Creates",
  "sandbox.db_missing_desc": "Openrind Shell sandboxes need a PostgreSQL connection for persistence. Set it before creating one.",
  "sandbox.db_missing_title": "DATABASE_URL is not configured",
  "sandbox.delete": "Delete",
  "sandbox.delete_body": "This removes the sandbox container {name}.",
  "sandbox.delete_confirm": "Delete sandbox",
  "sandbox.delete_keeps": "Your files and agent memory stay in the workspace and are restored into the next sandbox.",
  "sandbox.delete_removes": "The container and anything running in it are destroyed.",
  "sandbox.delete_title": "Delete this sandbox?",
  "sandbox.empty_body": "Sandboxes run your agent in an isolated container with its own workspace.",
  "sandbox.empty_cta": "Create a sandbox",
  "sandbox.failed_count_many": "{count} failed",
  "sandbox.failed_count_one": "1 failed",
  "sandbox.name_label": "Sandbox name",
  "sandbox.name_taken": "A sandbox with this name already exists.",
  "sandbox.new_sandbox": "New sandbox",
  "sandbox.new_sandbox_desc": "Initialize a new persistent, postgres-backed agent sandbox.",
  "sandbox.no_search_results": "No sandboxes match that search.",
  "sandbox.open": "Open",
  "sandbox.open_manager": "Open sandbox manager",
  "sandbox.options": "Sandbox options",
  "sandbox.panel_title": "Sandboxes",
  "sandbox.refresh": "Refresh",
  "sandbox.rename": "Rename",
  "sandbox.rename_body": "Choose a display name for this sandbox. The underlying sandbox name does not change.",
  "sandbox.rename_title": "Rename sandbox",
  "sandbox.row_actions": "Sandbox actions",
  "sandbox.search_placeholder": "Filter sandboxes",
  "sandbox.settings": "Sandbox settings",
  "sandbox.status_active": "Connected",
  "sandbox.status_deleting": "Deleting",
  "sandbox.status_failed": "Failed to start",
  "sandbox.status_idle": "Not connected",
  "sandbox.status_starting": "Starting",
  "sandbox.status_stopped": "Stopped",
  "sandbox.status_unhealthy": "Agent not responding",
  "sandbox.status_unknown": "Unknown",
  ...
  "session.attachments_connect_server": "Connect to Openrind Desktop server to attach files.",
  "session.back": "Back",
  ...
  "session.connect_to_sync": "Connect to Openrind Desktop server to sync remote files.",
  ...
  "session.pick_folder_desc": "Choose an existing project or notes folder and Openrind Desktop will use it as your workspace.",
  ...
  "session.share_host_url_and_token_required": "Openrind Desktop host URL and token are required.",
  "session.share_local_host_not_ready": "Local Openrind Desktop host is not ready yet.",
  "session.share_missing_host_url": "Missing Openrind Desktop host URL.",
  "session.share_missing_token": "Missing Openrind Desktop token.",
  ...
  "session.share_openrind_desktop_workers_only": "Share service links are available for Openrind Desktop workers.",
  ...
  "session.share_resolve_local_workspace_failed": "Could not resolve this workspace on the local Openrind Desktop host.",
  "session.share_resolve_remote_workspace_failed": "Could not resolve this workspace on the Openrind Desktop host.",
  ...
  "session.share_sign_in_required": "Sign in to Openrind Desktop Cloud in Settings to share with your team.",
  "session.share_skills_set_desc": "Complete skills set from an Openrind Desktop workspace.",
  ...
  "session.upload_connect_server": "Connect to the Openrind Desktop server to upload files to the shared folder.",
  ...
  "session.workspace_setup_desc": "Start with a guided Openrind Desktop workspace, or choose an existing folder you want to work in.",
  ...
  "settings.background_checks_desc": "Openrind Desktop always checks on launch. Also checks once",
  ...
  "settings.capabilities_title": "Openrind Desktop server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point Openrind Desktop at a local OpenCode build",
  ...
  "settings.debug_openrind_desktop_server_version": "Openrind Desktop server: {version}",
  ...
  "settings.deeplink_hint": "Accepts openrind-desktop://, openrind-desktop-dev://, or a raw supported https://share.openrind-desktoplabs.com/b/... URL.",
  ...
  "settings.docker_containers_desc": "Force-remove Docker containers launched by Openrind Desktop",
  "settings.docker_containers_title": "Openrind Desktop Docker containers",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by Openrind Desktop. Off by default.",
  ...
  "settings.feedback_title": "Help shape Openrind Desktop",
  ...
  "settings.nuke_confirm_dev": "This is irreversible. It WILL delete all Openrind Desktop data for this dev build and all isolated OpenCode dev config, auth, cache, data, and state, then quit Openrind Desktop. Continue?",
  "settings.nuke_confirm_prod": "This is irreversible. It WILL delete all Openrind Desktop data for this dev build and all isolated OpenCode dev config, auth, cache, data, and state, then quit Openrind Desktop. Continue?",
  "settings.nuke_failed": "Failed to remove Openrind Desktop and OpenCode state.",
  "settings.nuke_hint": "Use this only when you want to fully reset the desktop app and its OpenCode runtime state.",
  "settings.nuke_success": "Removed Openrind Desktop and OpenCode state. Openrind Desktop is closing...",
  "settings.off": "Off",
  "settings.offline": "Offline",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste an Openrind Desktop deeplink or share URL to open it.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by Openrind Desktop.",
  ...
  "settings.openrind_desktop_config_sidecar_desc": "Local Openrind Desktop server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.openrind_desktop_diagnostics_title": "Openrind Desktop server diagnostics",
  "settings.openrind_desktop_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openrind_desktop_server_label": "Openrind Desktop server",
  ...
  "settings.quit_hint": "Openrind Desktop quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect Openrind Desktop server.",
  "settings.reconnected": "Reconnected to Openrind Desktop server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears Openrind Desktop cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears Openrind Desktop cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. Openrind Desktop will restart.",
  ...
  "settings.reset_onboarding_description": "Clears Openrind Desktop preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears Openrind Desktop local preferences and workspace onboarding markers.",
  "settings.reset_openrind_desktop_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside openrind-desktop-dev-data.",
  "settings.reset_openrind_desktop_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside openrind-desktop-dev-data.",
  "settings.reset_openrind_desktop_title": "Reset Openrind Desktop + OpenCode state",
  ...
  "settings.restart_blocked_message": "Openrind Desktop needs to restart to finish this update. To avoid interrupting your current work, install is paused until your active runs finish or you stop them.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_openrind_desktop_server": "Restart Openrind Desktop server",
  ...
  "settings.services_section_desc": "Local services that power this Openrind Desktop session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting Openrind Desktop.",
  ...
  "settings.runtime_desc": "Status for your local engine and Openrind Desktop server.",
  ...
  "settings.tab_description_appearance": "Adjust how Openrind Desktop looks across desktop, system theme, and app chrome.",
  "settings.tab_description_debug": "Review runtime diagnostics, logs, and low-level debugging utilities.",
  "settings.tab_description_den": "Manage your Openrind Desktop Cloud connection, hosted workers, and workspace access.",
  "settings.tab_description_extensions": "Manage MCP apps and OpenCode plugins for this workspace.",
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected Openrind Desktop workspace plus its runtime connection.",
  ...
  "settings.environment.footer_hint": "OPENRIND_DESKTOP_ and OPENCODE_ keys are reserved for app/runtime wiring. Configure OpenCode runtime settings from your shell.",
  "settings.environment.override_hint": "Environment variables set before Openrind Desktop starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "Openrind Desktop will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "Openrind Desktop is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but Openrind Desktop status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "OPENRIND_DESKTOP_ and OPENCODE_ names are managed by Openrind Desktop/OpenCode.",
  ...
  "settings.tab_description_haloop": "Monitor the required inference route and private trace collector used by Claude and OpenClaw sandboxes.",
  "settings.tab_description_billing": "Manage subscription, payments, and view detailed AI usage statistics.",
  ...
  "settings.tab_billing": "Billing & Usage",
  ...
  "settings.updates_desc": "Keep Openrind Desktop up to date.",
  ...
  "settings.workspace_config_desc": ".opencode/openrind-desktop.json",
  ...
  "share.cloud_signin_note": "Openrind Desktop Cloud opens in your browser and returns here after sign-in.",
  ...
  "share.team_intro": "Save this template to your active Openrind Desktop Cloud organization so teammates can open it later from Cloud settings.",
  ...
  "share.template_item_config_desc": "Reusable commands plus Openrind Desktop/OpenCode config.",
  ...
  "share_skill_destination.connect_remote_desc": "Attach an Openrind Desktop host, then choose it from the list to import this skill.",
  "share_skill_destination.connect_remote_hint": "Attach an Openrind Desktop host, then choose it from the list to import this skill.",
  ...
  "sidebar.tab_sandboxes": "Sandboxes",
  "sidebar.tab_sessions": "Sessions",
  ...
  "skills.add_openrind_desktop_hub": "Add Openrind Desktop Hub",
  ...
  "skills.cloud_install_need_server": "Connect to an Openrind Desktop server with skills write access to install team skills on this worker.",
  ...
  "skills.cloud_org_fallback": "Openrind Desktop Cloud",
  "skills.cloud_org_load_failed": "Failed to load organization skills.",
  "skills.cloud_refresh": "Refresh team skills",
  "skills.cloud_section_subtitle": "Skills shared with you through Openrind Desktop Cloud — including team skill hubs you can access.",
  ...
  "skills.cloud_sign_in_hint": "Sign in to Openrind Desktop Cloud to browse team and org skills.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected Openrind Desktop server.",
  ...
  "skills.share_chooser_subtitle": "Save to your Openrind Desktop Cloud organization or publish a public install link.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active Openrind Desktop Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active Openrind Desktop Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "Openrind Desktop Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full Openrind Desktop features",
  ...
  "status.openrind_desktop_ready": "Openrind Desktop Ready",
  ...
  "system.reload_body_default": "Openrind Desktop detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "Openrind Desktop detected OpenCode configuration changes. Reload the engine to apply them.",
