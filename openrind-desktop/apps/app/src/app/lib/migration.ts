...
export const MIGRATION_KEY_PATTERNS: Array<RegExp> = [
  /^openrind-desktop\.react\.activeWorkspace$/,
  /^openrind-desktop\.react\.sessionByWorkspace$/,
  /^openrind-desktop\.server\.list$/,
  /^openrind-desktop\.server\.active$/,
  /^openrind-desktop\.server\.urlOverride$/,
  /^openrind-desktop\.server\.token$/,
];
...
function electronMigrationBridge(): ElectronMigrationBridge | null {
  ...
  const bridge = (window as unknown as {
    __OPENRIND_DESKTOP_ELECTRON__?: { migration?: ElectronMigrationBridge };
...
export const MIGRATION_DEFER_KEY = "openrind-desktop.migration.deferredUntil";
