import type {
  ...
  WorkspaceOpenrindDesktopConfig,
} from "../types";
...
export function defaultBlueprintSessionsForPreset(_preset: string): WorkspaceBlueprintSessionTemplate[] {
  return [
    {
      id: "welcome-to-openrind-desktop",
...
export function blueprintSessions(config: WorkspaceOpenrindDesktopConfig | null | undefined): WorkspaceBlueprintSessionTemplate[] {
...
export function blueprintMaterializedSessions(config: WorkspaceOpenrindDesktopConfig | null | undefined): WorkspaceBlueprintMaterializedSession[] {
...
export function normalizeWorkspaceOpenrindDesktopConfig(
  value: unknown,
  preset?: string | null,
): WorkspaceOpenrindDesktopConfig {
  const candidate =
    value && typeof value === "object"
      ? (value as Partial<WorkspaceOpenrindDesktopConfig>)
      : {};
