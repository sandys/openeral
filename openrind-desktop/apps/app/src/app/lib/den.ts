...
} from "@openrind/types/den/desktop-app-restrictions";
...
import { isDesktopDeployment } from "./openrind-desktop-deployment";
import {
...
const STORAGE_BASE_URL = "openrind-desktop.den.baseUrl";
const STORAGE_API_BASE_URL = "openrind-desktop.den.apiBaseUrl";
const STORAGE_AUTH_TOKEN = "openrind-desktop.den.authToken";
const STORAGE_ACTIVE_ORG_ID = "openrind-desktop.den.activeOrgId";
const STORAGE_ACTIVE_ORG_SLUG = "openrind-desktop.den.activeOrgSlug";
const STORAGE_ACTIVE_ORG_NAME = "openrind-desktop.den.activeOrgName";
const DEFAULT_DEN_TIMEOUT_MS = 12_000;

export const DEFAULT_DEN_AUTH_NAME = "Openrind Desktop User";
const BUILD_DEN_BASE_URL =
  (typeof import.meta !== "undefined" && typeof import.meta.env?.VITE_DEN_BASE_URL === "string"
    ...
    : "").trim() || "https://app.openrind-desktoplabs.com";
...
function isWebAppHost(hostname: string): boolean {
  ...
  return normalized === "app.openrind-desktoplabs.com" || normalized === "app.openrind-desktop.software" || normalized.startsWith("app.");
}
...
export function buildDenAuthUrl(baseUrl: string, mode: "sign-in" | "sign-up"): string {
  ...
  if (isDesktopDeployment()) {
    ...
    target.searchParams.set("desktopScheme", "openrind-desktop");
  }
...
function getWorkerTokens(payload: unknown): DenWorkerTokens | null {
  ...
  return {
    ...
    openrindDesktopUrl: connect && typeof connect.openrindDesktopUrl === "string" ? connect.openrindDesktopUrl : null,
