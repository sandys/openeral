...
export const MODEL_PREF_KEY = "openrind-desktop.defaultModel";
export const SESSION_MODEL_PREF_KEY = "openrind-desktop.sessionModels";
export const THINKING_PREF_KEY = "openrind-desktop.showThinking";
export const VARIANT_PREF_KEY = "openrind-desktop.modelVariant";
export const LANGUAGE_PREF_KEY = "openrind-desktop.language";
export const HIDE_TITLEBAR_PREF_KEY = "openrind-desktop.hideTitlebar";
