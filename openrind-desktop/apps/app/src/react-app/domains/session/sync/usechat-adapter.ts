...
import type { OpenrindDesktopSessionMessage, OpenrindDesktopSessionSnapshot } from "../../../../app/lib/openrind-desktop-server";
...
export function snapshotToUIMessages(snapshot: OpenrindDesktopSessionSnapshot): UIMessage[] {
...
export function createOpenrindDesktopChatTransport(options: TransportOptions): ChatTransport<UIMessage> {
  return {
    async sendMessages({ messages, abortSignal }) {
      const client = createClient(options.baseUrl, undefined, {
        token: options.openrindDesktopToken,
