// Composer toolbar button for ElevenLabs voice dictation. Press to record,
...
// cannot support recording and desktop transcription.
...
export function MicButton(props: MicButtonProps) {
  const { status, error, start, stop } = useVoiceInput(props.onTranscript);
