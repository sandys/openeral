...
const starterRoot = "/Users/test/Openrind Desktop/starter";
const otherRoot = "/Users/test/Openrind Desktop/second";
...
try {
  ...
  await step("windows create and list use the same transport directory", () => {
    ...
    const winRoot = String.raw`C:\Users\Test\Openrind Desktop\starter`;
    ...
    const verbatimDriveRoot = String.raw`\\?\C:\Users\Test\Openrind Desktop\starter`;
    assert.equal(toSessionTransportDirectory(verbatimDriveRoot), String.raw`C:\Users\Test\Openrind Desktop\starter`);
    assert.equal(describeDirectoryScope(verbatimDriveRoot).normalized, "c:/users/test/openrind-desktop/starter");
  });
  ...
  await step("round-trip invariant: every query path equals the create path (unix)", () => {
    ...
    const unixPaths = [
      "/Users/test/Openrind Desktop/starter",
      "/Users/test/Openrind Desktop/starter/",
  ...
  await step("round-trip invariant: every query path equals the create path (windows)", () => {
    ...
    const windowsPaths = [
      "C:\\Users\\Test\\Openrind Desktop\\starter",
      "C:\\Users\\Test\\Openrind Desktop\\starter\\",
      "D:\\projects\\my-app",
