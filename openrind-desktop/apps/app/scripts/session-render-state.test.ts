...
import type { OpenrindDesktopSessionSnapshot } from "../src/app/lib/openrind-desktop-server";
import {
...
function snapshotWithText(text: string, sessionId = "ses_test"): OpenrindDesktopSessionSnapshot {
  return {
    session: {
      id: sessionId,
      parentID: undefined,
    ...
    todos: [],
    status: { type: "idle" },
  } as unknown as OpenrindDesktopSessionSnapshot;
}
