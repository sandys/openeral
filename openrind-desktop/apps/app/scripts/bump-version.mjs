...
const updatePackageJson = async (nextVersion) => {
  ...
  // Ensure openrind-desktop-orchestrator uses the same openrind-desktop-server/opencode-router versions.
  orchestratorData.dependencies = orchestratorData.dependencies ?? {};
  orchestratorData.dependencies["openrind-desktop-server"] = nextVersion;
