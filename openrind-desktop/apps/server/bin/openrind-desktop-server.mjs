...
const binaryName = process.platform === "win32" ? "openrind-desktop-server.exe" : "openrind-desktop-server";
...
console.error(
  `Unable to find an Openrind Desktop server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
