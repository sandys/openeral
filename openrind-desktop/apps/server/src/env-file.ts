...
// them into every spawned child (OpenCode, Openrind Desktop server, opencode-router).
...
// is for service credentials, not Openrind Desktop/OpenCode runtime knobs; users who
  ...
  constructor(key: string, code: "invalid_env_key" | "reserved_env_key") {
    super(
      code === "reserved_env_key"
        ? `Environment variable name is reserved for Openrind Desktop internals: ${key}`
