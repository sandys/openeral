    ...
    parts: [
      {
        type: "text",
        text:
          "Build a faithful story-book for the Openrind Desktop app so we can iterate on the shell, session timeline, settings cards, and onboarding without touching the live runtime. Also make the mocked transcript feel closer to a real Openrind Desktop session, including tool activity.",
      } as Part,
    ],
  },
  {
...
export const settingsCards = [
  {
    ...
    body: "Status for your local engine and Openrind Desktop server with versioning, connection health, and repair actions.",
    points: [
      "OpenCode engine ready on localhost:4096",
      "Openrind Desktop server proxied for remote workers",
...
export const onboardingChoices = [
  {
    ...
    detail: "Spin up a local Openrind Desktop folder with reusable skills and project memory.",
  },
  {
    title: "Connect remote worker",
    detail: "Attach to a hosted worker using Openrind Desktop URL + token for shared remote execution.",
  },
];
