...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    other: props.missing
      ? undefined
      : {
          "openrind-desktop:bundle-id": props.id!,
          "openrind-desktop:bundle-type": props.bundleType!,
          "openrind-desktop:schema-version": props.schemaVersion!,
          "openrind-desktop:open-in-app-url": props.openInAppDeepLink!
        }
  };
}
