...
export const metadata: Metadata = {
  ...
  title: {
    default: "Openrind Desktop Share",
    template: "%s - Openrind Desktop Share"
  },
  description: "Publish Openrind Desktop worker packages and shareable import links.",
  icons: { icon: "/openrind-desktop-mark.svg" },
  openGraph: {
    type: "website",
    siteName: "Openrind Desktop Share",
  },
  twitter: {
    card: "summary_large_image",
    site: "@getopenrind-desktop",
  },
};
