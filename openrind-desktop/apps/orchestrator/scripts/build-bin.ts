...
const serverBin = resolve(root, "..", "server", "dist", "bin", "openrind-desktop-server");
...
await copyFile(serverBin, resolve(targetDir, "openrind-desktop-server"));
...
const versions = {
  "openrind-desktop-server": {
    ...
    sha256: await sha256(resolve(targetDir, "openrind-desktop-server")),
  },
  "opencode-router": {
