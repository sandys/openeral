...
const serviceCycle = ["all", "openrind-desktop-orchestrator", "opencode", "openrind-desktop-server", "router"];
          ...
          <Show when={state.view === "overview"}>
            <box flexDirection="row" gap={4} paddingTop={1}>
              ...
              <box width={Math.floor(dimensions().width / 2) - 4} flexDirection="column" gap={1}>
                ...
                <text fg={theme.textMuted}>Openrind Desktop URL (LAN)</text>
                <text fg={theme.text}>{state.connect.openrindDesktopUrl}</text>
                <text fg={theme.textMuted}>Openrind Desktop Collaborator Token</text>
                <text fg={theme.text}>{state.connect.openrindDesktopToken}</text>
                <Show when={state.connect.ownerToken}>
                  <text fg={theme.textMuted}>Openrind Desktop Owner Token</text>
                  <text fg={theme.text}>{state.connect.ownerToken}</text>
                </Show>
                <text fg={theme.textMuted}>Openrind Desktop Host Admin Token</text>
