...
- deep links: `openrind-desktop://` and `openrind-desktop-dev://`
...
- renderer access to localhost/Openrind Desktop/OpenCode HTTP surfaces
...
apps/desktop/src-tauri/src/commands/openrind_desktop_server.rs: 2
...
apps/app/src/app/lib/openrind-desktop-server.ts
...
- `server-provider.tsx`, `openrind-desktop-server.ts`, `opencode.ts`, `den.ts`, and `bundles/sources.ts` use Tauri HTTP fetch in desktop mode.
...
apps/app/src/react-app/domains/connections/openrind-desktop-server-store.ts
...
apps/desktop/src-tauri/src/openrind_desktop_server/manager.rs
apps/desktop/src-tauri/src/openrind_desktop_server/mod.rs
apps/desktop/src-tauri/src/openrind_desktop_server/spawn.rs
...
- `workspace/watch.rs` emits `openrind-desktop://reload-required` from native file-watch events.
...
- `engine/*`, `orchestrator/*`, `openrind_desktop_server/*`, and `opencode_router/*` currently spawn and supervise local child processes.
...
apps/desktop/src-tauri/src/commands/openrind_desktop_server.rs
...
scripts/openrind-desktop-debug.sh
...
- `openrind-desktop-debug.sh` kills Tauri dev processes.
...
```text
prds/openrind-desktop-desktop-bootstrap-config/desktop-bootstrap-and-org-runtime-config.md
...
1. Keep the package name `@openrind/desktop` and replace internals in place, or create a parallel Electron package and cut over later.
