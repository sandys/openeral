...
PROJECT_NAME="openrind-desktop-web-local"
...
: "${DATABASE_URL:=mysql://root:password@127.0.0.1:3306/openrind_desktop_den}"
...
pnpm --filter @openrind-ee/den-db db:push <<'EOF'
y
EOF
...
(
  ...
  env \
    ...
    NEXT_PUBLIC_OPENRIND_DESKTOP_AUTH_CALLBACK_URL="$DEN_WEB_ORIGIN" \
