...
SNAPSHOT_NAME="${1:-${DAYTONA_SNAPSHOT_NAME:-openrind-desktop-runtime}}"
...
LOCAL_IMAGE_TAG="${DAYTONA_LOCAL_IMAGE_TAG:-openrind-desktop-daytona-snapshot:${SNAPSHOT_NAME//[^a-zA-Z0-9_.-]/-}}"
...
echo "- openrind-desktop-orchestrator@$OPENRIND_DESKTOP_ORCHESTRATOR_VERSION" >&2
