...
check("openrind-desktop-orchestrator", orchestratorVersion);
check("openrind-desktop-server", serverVersion);
...
console.log(`Release tag ${tag} matches app/desktop/openrind-desktop-orchestrator versions.`);
