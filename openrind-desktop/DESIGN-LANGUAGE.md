# Openrind Desktop Design Language

This is the definitive visual system for Openrind Desktop product and landing work.

Openrind Desktop should feel like a premium work tool: calm, useful, technical, and trustworthy. The design should read as software first, not a flashy marketing site. The goal is clarity with taste, not visual noise.

---

## 1. Core Design Position

Openrind Desktop design is:
...
Openrind Desktop design is **not**:
...
Borders are one of the main structure tools in Openrind Desktop.
...
Openrind Desktop should have a small set of radii and use them consistently.
...
Openrind Desktop copy should feel as disciplined as the UI.
...
### Preferred Openrind Desktop Cloud framing

For Openrind Desktop Cloud, the primary story is:
...
There are only a few button families in Openrind Desktop.
...
This is now one of the clearest Openrind Desktop patterns.
...
Openrind Desktop has two primary list patterns.
...
Openrind Desktop selection should feel confident, not loud.
...
## 15. Openrind Desktop App vs Landing
...
6. Would this still feel like Openrind Desktop if all colors were muted?
...
- Landing button + shell primitives: `_repos/openrind-desktop/ee/apps/landing/app/globals.css`
- Landing hero and selector patterns: `_repos/openrind-desktop/ee/apps/landing/components/landing-home.tsx`
- Landing demo list rhythm: `_repos/openrind-desktop/ee/apps/landing/components/landing-app-demo-panel.tsx`
- Cloud dashboard sidebar shell + selected state: `_repos/openrind-desktop/ee/apps/den-web/app/(den)/o/[orgSlug]/dashboard/_components/org-dashboard-shell.tsx`
- Share/package modal direction: `_repos/openrind-desktop/apps/app/src/app/components/share-workspace-modal.tsx`
- App workspace/session list rhythm: `_repos/openrind-desktop/apps/app/src/app/components/session/workspace-session-list.tsx`
