...
7. If releasing openrind-desktop-orchestrator sidecars, build deterministically with `SOURCE_DATE_EPOCH`, upload assets to `openrind-desktop-orchestrator-vX.Y.Z`, and publish `openrind-desktop-orchestrator`.
8. If `openrind-desktop-server` or `opencode-router` versions changed, publish those packages.
