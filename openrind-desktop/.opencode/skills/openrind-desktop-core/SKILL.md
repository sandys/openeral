---
name: openrind-desktop-core
description: Core context and guardrails for Openrind Desktop native app
---
...
- Openrind Desktop must stay within OpenCode's tool surface; avoid inventing new capabilities.
