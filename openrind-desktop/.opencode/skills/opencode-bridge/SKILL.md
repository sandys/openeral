...
description: Bridge between Openrind Desktop UI and OpenCode runtime
---

## Overview

Openrind Desktop communicates with OpenCode via three mechanisms:
...
Openrind Desktop can register as an MCP server that OpenCode connects to.
...
```json
{
  "mcpServers": {
    "openrind-desktop": {
      "type": "stdio",
      "command": "openrind-desktop-mcp-bridge"
    }
  }
}
```
...
### Use cases
- Real-time permission prompts surfaced in Openrind Desktop UI.
- Streaming progress updates.
- Custom tools exposed from Openrind Desktop (e.g., native file picker).
