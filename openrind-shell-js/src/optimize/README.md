...
Active token and cost optimization for Claude Code running in Openrind.
...
npx openrind-shell --optimize

# Disable optimizer
npx openrind-shell --no-optimize

# View statistics
npx openrind-shell optimize stats

# View stats for specific workspace
npx openrind-shell optimize stats --workspace my-project --days 30
```
...
OPENRIND_SHELL_OPTIMIZER=on|off

# Prefer Haiku for all tasks (maximum savings)
OPENRIND_SHELL_OPTIMIZER_PREFER_HAIKU=true

# Cache timeout (milliseconds)
OPENRIND_SHELL_OPTIMIZER_CACHE_TIMEOUT=3600000
```
...
Openrind Optimizer - Last 7 Days
════════════════════════════════════════════════════════════
...
CREATE TABLE _openrind.optimization_metrics (
...
CREATE TABLE _openrind.api_cache (
...
└───────────────────────────┬─────────────────────────────────┘
                            ...
                            ▼
┌─────────────────────────────────────────────────────────────┐
│  Openrind Optimizer Interceptor                              │
│  ┌──────────────────────────────────────────────────────┐   │
│  │ 1. Check Local Cache                                 │   │
